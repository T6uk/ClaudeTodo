...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (typeof gsap === 'undefined') {
        console.error('GSAP library not loaded. Cat animation requires GSAP.');
        return;
    }
    ...
    // Modify scale animation to be smaller and centered
    gsap.to(".cat-container svg", {
        scale: 1.5,
        repeat: -1,
        yoyo: true,
        duration: 5,
    ...
    // Rest of the animations can remain the same
    gsap.set("#smoke", {
        x: 10,
        y: 5
    });
